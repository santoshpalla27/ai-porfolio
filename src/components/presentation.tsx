...
export function Presentation() {
  ...
  const profile = {
    ...
    description:
      "Hey 👋\nI'm Santosh, a DevOps Engineer specializing in infrastructure automation, cloud technologies, CI/CD pipelines, and system reliability.",
    src: '/profile-santosh-03.jpeg',
    fallbackSrc:
      'https://images.unsplash.com/photo-1560250097-0b93528c311a?q=80&w=3570&auto=format&fit=crop&ixlib=rb-4.0.3',
  };
    ...
    <div className="mx-auto w-full max-w-5xl py-6 font-sans">
      <div className="grid grid-cols-1 items-center gap-10 md:grid-cols-2">
        ...
        <div className="flex flex-col space-y">
          ...
          >
            {['DevOps', 'Cloud', 'Automation', 'Kubernetes', 'AWS'].map(
              (tag) => (
                <span
                  key={tag}
